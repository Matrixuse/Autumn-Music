...
export default function Hollywood({ songs = [] }) {
    ...
    const handleSongClick = async (song) => {
        ...
        try {
            ...
            playTrack(resolvedSong, resolvedQueue)
        } catch {
            // The fallback card stays visible when the search provider is unavailable.
        }
    }
                                ...
                                >
                                    <div className="mr-3 flex items-center gap-3 rounded bg-transparent p-1 transition hover:bg-white/[0.02]">
                                        ...
                                        <div className="flex min-w-0 flex-col justify-between gap-1">
                                            ...
                                            <div className="flex min-w-0 items-center gap-2 truncate text-[15px] text-white/55">
