    ...
    <div className="space-y-8 text-white">
      <div className="flex items-center gap-3">
        <div className="flex flex-col">
          ...
          <h1 className="font-['Space_Grotesk'] text-4xl font-bold">Recently played</h1>
        </div>
      </div>
      ...
      {listenHistory.length ? (
        <div className="mb-20">
          <div className="flex items-center gap-3">
            <button type="button" onClick={playAll} className="flex items-center gap-2 rounded-full bg-[#eeece8] px-5 py-3 text-sm font-bold text-[#21160a]"><Play size={17} fill="currentColor" />Play all</button>
            <button type="button" onClick={shuffleAll} aria-label="Shuffle recently played songs" className="rounded-full border border-white/10 bg-white/6 p-3"><Shuffle size={18} /></button>
